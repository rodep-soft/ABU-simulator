...
```text
node --test sim/tests/engine.test.cjs sim/tests/transport-plan.test.cjs sim/tests/split-builder.test.cjs sim/tests/score-planner.test.cjs sim/tests/auto-retry.test.cjs
```
