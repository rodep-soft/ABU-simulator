(function (root, factory) {
  ...
  const DEFAULTS = { maxSpeed: 7, acceleration: 3.5, redSpeed: 1, blueSpeed: 1, redTrPlan: 'balanced', blueTrPlan: 'balanced', redBrPlan: 'score-search', blueBrPlan: 'score-search', bodySize: .5, rampFactor: .55, stairSpeed: .25, stairPause: .6, scanSeconds: 3, pickupSeconds: 1.5, placeSeconds: 2.5, brAutoRetrySeconds: 5 };
  ...
  class Simulation {
    ...
    relocateForRetry(r, level) {
      ...
      Object.assign(r, target, { z, enteredL1: level === 1, observation: null, scanLoaded: false, batchRemaining: 0,
        brain: { stage: 'start' }, queue: [], job: null, decision: null, velocity: 0, wait: 0, blocked: 0, stall: null, retryPending: null, failure: null });
    ...
    export() { return { format: 'robocon-field-sim-v1', config: this.config, assumptions: ['axis-aligned square body', 'ideal snapshot at BR home', 'two transfer columns, two layers', 'automatic BR retry after blocked movement: retain Earth/Sky, return Mustika to source', 'manual retry carrying Earth/Sky unsupported', 'no rigid-body tipping physics'], events: this.events, history: this.history, final: this.snapshot() }; }
  }
